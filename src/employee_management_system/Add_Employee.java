...
public class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("employee_management_system/icon/add_employee.jpg"));
        id15.setIcon(img);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                cc.s.executeUpdate(q);    //executeUpdate function is used for insert data into database and executeQueries is used for retrieve data from database.
